    ...
    return (
      <Router>
        <div>
          ...
          <PropsRoute exact path="/user/:userId" component={UserPage} isUserLoggedIn={this.state.isUserLoggedIn}/>
          <PropsRoute path="/image/:imageId" component={ImagePage} isUserLoggedIn={this.state.isUserLoggedIn} userId={this.state.user.id}/>
          <PropsRoute exact path="/user/edit/:userId" component={EditUser} />
        </div>
      </Router>
    );
  }
